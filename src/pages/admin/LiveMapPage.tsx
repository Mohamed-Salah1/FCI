...
const LiveMapPage = () => {
  ...
  const filteredBuses = busLocations.filter(
    (bus) =>
              ...
              <div className="flex-1 overflow-y-auto p-3 space-y-3">
                {filteredBuses.length > 0 ? (
                  filteredBuses.map((bus) => (
                    <div
                      key={bus.busId}
                      className="p-3 rounded-xl border border-border/50 bg-secondary/10 hover:bg-secondary/20 transition cursor-pointer"
                    >
              ...
              <div className="p-4 border-t border-border/50 text-xs">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">
                    {busLocations.filter((b) => b.status !== "idle").length}
                  </span>
                </div>
              </div>
            </motion.div>
